...
case class RowToVeloxColumnarExec(child: SparkPlan) extends SharedRowToColumnarExec(child) {

  override protected def preferredBatchBytes: Long = VeloxConfig.get.veloxPreferredBatchBytes
  ...
  override protected def sparkToBackendUnsafe[F, T](
    ...
    BroadcastUtils.sparkToVeloxUnsafe(sc, mode, schema, relation, itrTransformer)
  }
